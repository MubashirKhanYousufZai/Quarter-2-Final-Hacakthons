  ...
  return (
    <footer className="text-gray-900 bg-amber-300 body-font">
        <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <a className="text-gray-800" href='https://www.linkedin.com/in/mubashir-khan-538a662bb'>
                <FaLinkedin className='text-orange-700 text-4xl'/>
            </a>
            <a className="ml-3 text-gray-800" href='https://github.com/MubashirKhanYousufZai'>
                <FaGithub className='text-orange-700 text-4xl'/>
            </a>
            <a className="ml-3 text-gray-800" href='https://wa.me/qr/FWX3BWWPABVRG1'>
