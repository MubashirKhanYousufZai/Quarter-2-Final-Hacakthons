    ...
    <div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
            ...
            At Pizza Run, we accept a variety of payment methods to make your dining experience seamless. 
            Pay with ease using Easy Paisa or Jazz Cash, or opt for Cash on Delivery (COD) - our flexible 
            payment options make ordering from us a breeze. Whether you prefer digital transactions or good old cash, 
