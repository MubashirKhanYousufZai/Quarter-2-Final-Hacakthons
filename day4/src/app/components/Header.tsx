    ...
    <header className="text-gray-900 bg-amber-300 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center font-semibold">
          <a className="mr-5 cursor-pointer" href="/">
            Home
          </a>
          <a className="mr-5 cursor-pointer" href="/components/menu">
            Menu
          </a>
          <a className="mr-5 cursor-pointer" href="/components/about">
            About-us
          </a>
          <a className="mr-5 cursor-pointer" href="/components/contact">
            Contact-us
          </a>
        </nav>
        <div className="flex gap-2">
          ...
          <a href="/components/cart">
            <TfiShoppingCart className="text-orange-700 text-4xl" />
          </a>
          <a href="/components/profile">
            <VscAccount className="text-orange-700 text-4xl" />
          </a>
        </div>
      </div>
    </header>
